...
const demoProducts = [
  {
    ...
    badge: "ultra-processed" as const,
      ...
      <main className="container mx-auto px-4 pt-24 pb-20">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-4 animate-fade-in">
            <StatusBadge variant="safe" className="uppercase text-xs font-semibold tracking-wider">
              Live Demo
            </StatusBadge>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16">
          {demoProducts.map((product, index) => (
            <div key={product.id} style={{ animationDelay: `${0.2 + index * 0.1}s` }}>
              <ProductCard {...product} />
            </div>
          ))}
        </div>
        ...
        <div className="text-center animate-fade-in" style={{ animationDelay: "0.5s" }}>
          <p className="text-muted-foreground mb-3">Already know what you're eating?</p>
          <button
            onClick={() => navigate("/")}
