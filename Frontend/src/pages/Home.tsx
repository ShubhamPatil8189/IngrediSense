...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-20">
      ...
      {/* Input Card */}
      <div 
        className="w-full max-w-xl glass-card p-6 animate-fade-in"
      ...
      >
        ...
        <Button
          variant="secondary"
          className="w-full mb-3 bg-secondary hover:bg-secondary/80 text-foreground border border-border"
        >
        ...
        <Button
          ...
          className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold h-12 text-base animate-pulse-glow"
        >
      ...
      <button
        onClick={handleDemo}
        className="mt-8 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors animate-fade-in"
